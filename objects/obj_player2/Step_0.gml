...
var press_left = keyboard_check_pressed(ord("A"));
var press_jump = keyboard_check_pressed(ord("W"));
var release_jump = keyboard_check_released(ord("W"))
var press_dive = keyboard_check_pressed(ord("S"));
...
if (lap < obj_player1.lap) && (obstacleCurrentCooldown <= 0)
{
	if press_left 
	{
...
else if (lap = obj_player1.lap) && (x < obj_player1.x) && (obstacleCurrentCooldown <= 0)
{
	if press_left 
	{
		instance_create_depth(x-100,y,0,obj_wall)
